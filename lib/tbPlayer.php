...
function getPlayersFromDB() {
  $db = connect_db();
  $result = $db->query('SELECT id, created, clientID, avatar, firstname, lastname, email, city, country, playerProviderID, playerProviderToken, providerAccessToken, providerRefreshToken, providerTokenExpires, last_activity, last_updated FROM players LIMIT 10');
  $rows = array();
  $index = 0;
