...
function buildSocialGameImage($paramaObj) {
  ...
  $params = array("w" => 600, "txtfont64" => "Avenir Next Condensed Demi,Bold", "txtalign" => 'right', "txtclr" => 'fff', "txtpad" => 0, "txtsize" => 55, "txt64" => $strComplete);
  ...
  // final image
  $params = array("w" => 1200, "h" => 630, "fit" => "crop", "q" => 80, "markx" => 0, "marky" => 480, "mark64" => $bottomImg,
  "bw" => 1200, "bh" => 630, "bm" => 'normal', "blend64" => $overlayImg);
  $finalImg = $builder->createURL("challenges/" . $paramaObj->image, $params);
