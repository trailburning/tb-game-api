...
function replaceTags($strText, $game, $player, $activePlayer, $activity) {
  ...
  $tags = array('[CAMPAIGN_ID]', '[INVITE_LINK]', '[GAME_LINK]', '[PLAYER_LINK]', '[PLAYER_FIRSTNAME]', '[PLAYER_LASTNAME]', '[ACTIVE_PLAYER_LINK]', '[ACTIVE_PLAYER_FIRSTNAME]', '[ACTIVE_PLAYER_LASTNAME]', '[GAME_TYPE]', '[GAME_NAME]', '[ACTIVITY_ELEVATION]', '[ACTIVITY_DISTANCE]', '[PROFILE_LINK]', '[PREFERENCES_LINK]', '[FUNDRAISING_LINK]');
  $replaceTags = array($game['campaignID'], '<a href=\"' . MR_SECURE_DOMAIN . 'campaign/' . $game['campaignID'] . '/invite\">here</a>', '<a href=\"' . MR_SECURE_DOMAIN . 'game/' . $game['id'] . '\">here</a>', '<a href=\"' . MR_SECURE_DOMAIN . 'game/' . $game['id'] . '/player/' . $player['id'] . '\">here</a>', $player['firstname'], $player['lastname'], '<a href=\"' . MR_SECURE_DOMAIN . 'game/' . $game['id'] . '/player/' . $activePlayer['id'] . '\">here</a>', $activePlayer['firstname'], $activePlayer['lastname'], $gameType, $game['level_name'], floor($activity['total_elevation_gain']), number_format($activity['distance'] / 1000, 1), '<a href=\"' . MR_SECURE_DOMAIN . 'campaign/' . $game['campaignID'] . '/profile\">profile</a>', '<a href=\"' . MR_SECURE_DOMAIN . 'campaign/' . $game['campaignID'] . '/preferences\">update your preferences</a>', '<a href=\"' . $game['fundraising_page'] . $activePlayer['fundraising_page'] . '\">' . $game['fundraising_provider'] . '</a>');
