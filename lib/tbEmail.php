...
function replaceTags($strText, $game, $player, $activePlayer, $activity) {
  ...
  $replaceTags = array($game['campaignID'], '<a href=\"' . MR_SECURE_DOMAIN . 'campaign/' . $game['campaignID'] . '/invite\">here</a>', '<a href=\"' . MR_SECURE_DOMAIN . 'game/' . $game['id'] . '\">here</a>', '<a href=\"' . MR_SECURE_DOMAIN . 'game/' . $game['id'] . '/player/' . $player['id'] . '\">here</a>', $player['firstname'], $player['lastname'], '<a href=\"' . MR_SECURE_DOMAIN . 'game/' . $game['id'] . '/player/' . $activePlayer['id'] . '\">here</a>', $activePlayer['firstname'], $activePlayer['lastname'], $gameType, $game['level_name'], floor($activity['total_elevation_gain']), $activity['distance'], '<a href=\"' . MR_SECURE_DOMAIN . 'campaign/' . $game['campaignID'] . '/profile\">profile</a>', '<a href=\"' . MR_SECURE_DOMAIN . 'campaign/' . $game['campaignID'] . '/preferences\">update your preferences</a>', '<a href=\"' . $game['fundraising_page'] . $activePlayer['fundraising_page'] . '\">' . $game['fundraising_provider'] . '</a>');
